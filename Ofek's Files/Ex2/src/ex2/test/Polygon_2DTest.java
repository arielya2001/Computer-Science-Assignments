...
class Polygon_2DTest {
    ...
    void equal(){
        ...
        Polygon_2D vertex4 = new Polygon_2D(); // The polygons have the same points in the same order in different index's, there for they equals.
        vertex4.add(p2); vertex4.add(p3); vertex4.add(p4); vertex4.add(p5); vertex4.add(p1);
        assertTrue(vertex1.equals(vertex4),"The arrays should be equal");

        Polygon_2D vertex3 = new Polygon_2D(); // The polygons don't have the same number of points.
        ...
        Polygon_2D vertex5 = new Polygon_2D(); // The polygons have the same points but not in the same order, there for they not equals
        vertex3.add(p1); vertex3.add(p3); vertex3.add(p2); vertex3.add(p5); vertex5.add(p4);
        assertFalse(vertex1.equals(vertex5),"The arrays shouldn't be equal");
    }
}