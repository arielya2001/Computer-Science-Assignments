...
/////////////////////////////////////// Test functions: ///////////////////////////////////////////////////////////////
    ...
    /**
     * Parameterized tests for the Rect_2D class to validate the getP1() method.
     */
    @ParameterizedTest
    ...
    /**
     * Parameterized tests for the Rect_2D class to validate the getP2() method.
     */
    @ParameterizedTest
    @MethodSource("rectProvider")
    ...
    /**
     * Parameterized tests for the Rect_2D class to validate the getP3() method.
     */
    @ParameterizedTest
    @MethodSource("rectProvider")
    ...
    /**
     * Parameterized tests for the Rect_2D class to validate the getP4() method.
     */
    @ParameterizedTest
    @MethodSource("rectProvider")
    ...
    /**
     * Parameterized tests for the Rect_2D class to validate the contains() method.
     */
    @ParameterizedTest
    @MethodSource("rectProvider")
    ...
    /**
     * Parameterized tests for the Rect_2D class to validate the area() method.
     */
    @ParameterizedTest
    @MethodSource("rectProvider")
    ...
    /**
     * Parameterized tests for the Rect_2D class to validate the perimeter() method.
     */
    @ParameterizedTest
    @MethodSource("rectProvider")
    ...
    /**
     * Parameterized tests for the Rect_2D class to validate the translation() method.
     */
    @ParameterizedTest
    @MethodSource("rectProvider")
    ...
    /**
     * Parameterized tests for the Rect_2D class to validate the copy() method.
     */
    @ParameterizedTest
    @MethodSource("rectProvider")
    ...
    /**
     * Parameterized tests for the Rect_2D class to validate the scale() method.
     */
    @ParameterizedTest
    @MethodSource("rectProvider")
    ...
    /**
     * Parameterized tests for the Rect_2D class to validate the rotate() method.
     */
    @ParameterizedTest
    @MethodSource("rectProvider")
    ...
    /**
     * Parameterized tests for the Rect_2D class to validate the toString() method.
     */
    @ParameterizedTest
    @MethodSource("rectProvider")
    ...
    /**
     * Parameterized tests for the Rect_2D class to validate the equals() method.
     */
    @ParameterizedTest
    @MethodSource("rectProvider")
    void equals(Rect_2D rect) {
        Point_2D p1 = new Point_2D(1, 3);
        Point_2D p2 = new Point_2D(5, 1);
        Rect_2D expectedRect = new Rect_2D(p1, p2);

        // Test equality with itself
        assertTrue(rect.equals(rect));

        // Test equality with an identical rectangle
        assertTrue(rect.equals(expectedRect));

        // Test equality with a null object
        assertFalse(rect.equals(null));

        // Test equality with a different type object
        assertFalse(rect.equals(p1));

        // Test equality with a rectangle with different points
        Point_2D differentP1 = new Point_2D(0, 0);
        Rect_2D differentRect = new Rect_2D(differentP1, p2);
