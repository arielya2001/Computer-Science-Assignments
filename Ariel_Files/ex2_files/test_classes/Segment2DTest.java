...
class Segment2DTest {
    ...
    private static Stream<Arguments> segmentProvider() {
        return Stream.of(
                arguments(new Segment_2D(new Point_2D(0, 0), new Point_2D(4, 0)), new Segment_2D(new Point_2D(0, 0), new Point_2D(4, 0)), true),
                arguments(new Segment_2D(new Point_2D(2, 2), new Point_2D(6, 2)), new Segment_2D(new Point_2D(6, 2), new Point_2D(2, 2)), true),
                arguments(new Segment_2D(new Point_2D(-1, -1), new Point_2D(3, -1)), new Segment_2D(new Point_2D(-1, -1), new Point_2D(3, -1)), true),
                arguments(new Segment_2D(new Point_2D(0, 0), new Point_2D(4, 0)), new Segment_2D(new Point_2D(0, 0), new Point_2D(4, 1)), false),
                arguments(new Segment_2D(new Point_2D(2, 2), new Point_2D(6, 2)), new Segment_2D(new Point_2D(6, 2), new Point_2D(2, 3)), false),
                arguments(new Segment_2D(new Point_2D(-1, -1), new Point_2D(3, -1)), new Segment_2D(new Point_2D(-1, -1), new Point_2D(3, 0)), false)
        );
    }

    /**
     * Parameterized tests for the Segment_2D class to validate the get_p1() method.
     */
    @ParameterizedTest
    ...
    /**
     * Parameterized tests for the Segment_2D class to validate the get_p2() method.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Parameterized tests for the Segment_2D class to validate the contains() method.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Parameterized tests for the Segment_2D class to validate the area() method.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Parameterized tests for the Segment_2D class to validate the perimeter() method.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Parameterized tests for the Segment_2D class to validate the translation method.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Parameterized tests for the Segment_2D class to validate the copy() method.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Parameterized tests for the Segment_2D class to validate the scale() method.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Parameterized tests for the Segment_2D class to validate the rotate() method.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Parameterized tests for the Segment_2D class to validate the testToString() method.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Parameterized tests for the Segment_2D class to validate the equals() method.
     */
    @ParameterizedTest
    @MethodSource("segmentProvider")
    void testEquals(Segment_2D segment1, Segment_2D segment2, boolean expectedResult) {
        assertEquals(expectedResult, segment1.equals(segment2), "Segments equality check failed");
    }
