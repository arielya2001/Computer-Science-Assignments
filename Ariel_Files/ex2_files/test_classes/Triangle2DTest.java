...
class Triangle2DTest {
    ...
    private static Stream<Arguments> pointProvider() {
        return Stream.of(
                ...
                arguments(new Point_2D(-2, 3), new Point_2D(4, 5), new Point_2D(-6, 1)),
                arguments(new Point_2D(-1, -1), new Point_2D(-2, -3), new Point_2D(2, 4)),
                arguments(new Point_2D(5, 5), new Point_2D(6, 5), new Point_2D(5, 6))
        );
    }

    /**
     * Test to verify the getAllPoints() method of the Triangle_2D class.
     */
    @ParameterizedTest
    ...
    /**
     * Test to verify the contains() method of the Triangle_2D class.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Test to verify the area() method of the Triangle_2D class.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Test to verify the perimeter() method of the Triangle_2D class.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Test to verify the translation method of the Triangle_2D class.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Test to verify the copy() method of the Triangle_2D class.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Test to verify the scale() method of the Triangle_2D class.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Test to verify the rotate() method of the Triangle_2D class.
     */
    @Test
    void testRotate() {
    ...
    /**
     * Test to verify the toString() method of the Triangle_2D class.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    ...
    /**
     * Test to verify the equals() method of the Triangle_2D class.
     */
    @ParameterizedTest
    @MethodSource("pointProvider")
    void testEquals(Point_2D p1, Point_2D p2, Point_2D p3) {
        Triangle_2D triangle1 = new Triangle_2D(p1, p2, p3);

        // Create a triangle with the same points but in a different order
        Triangle_2D triangle2 = new Triangle_2D(p2, p3, p1);

        assertEquals(triangle1, triangle2, "Triangles should be equal regardless of the order of points.");
    }
