...
class ShapeCollectionTest {
    ...
    /**
     * Tests for the ShapeCollection class.
     */
    @BeforeEach
    void setUp() {
    ...
    /**
     * Test to verify the add() method of the ShapeCollection class.
     */
    @Test
    void testAdd() {
        // Adding shapes
    ...
    /**
     * Test to verify the size() method of the ShapeCollection class.
     */
    @Test
    void testSize() {
        // Adding shapes
    ...
    /**
     * Test to verify the removeElementAt() method of the ShapeCollection class.
     */
    @Test
    ...
    /**
     * Test to verify the copy() method of the ShapeCollection class.
     */
    @Test
    void testCopy() {
        // Adding shapes
    ...
    /**
     * Test to verify the get() method of the ShapeCollection class.
     */
    @Test
    void testGet() {
    ...
    /**
     * Test to verify the addAt() method of the ShapeCollection class.
     */
    @Test
    void testAddAt() {
        GUIShape shape = new GUIShape(new Circle_2D(new Point_2D(1, 1), 5), true, Color.RED, 1);
    ...
    /**
     * Test to verify the sort() method of the ShapeCollection class.
     */
    @Test
    void testSort() {
        // Create shapes
    ...
    /**
     * Test to verify the removeAll() method of the ShapeCollection class.
     */
    @Test
    void testRemoveAll() {
        shapeCollection.add(new GUIShape(new Circle_2D(new Point_2D(1, 1), 5), true, Color.RED, 1));
    ...
    /**
     * Test to verify the save() method of the ShapeCollection class.
     */
    @Test
    void testSave() {
        // Add shapes to the collection
    ...
    /**
     * Test to verify the load() method of the ShapeCollection class.
     */
    @Test
    void testLoad() {
    ...
    /**
     * Test to verify the toString() method of the ShapeCollection class.
     */
    @Test
    void testToString() {
        shapeCollection.add(new GUIShape(new Circle_2D(new Point_2D(1, 1), 5), true, Color.RED, 1));
