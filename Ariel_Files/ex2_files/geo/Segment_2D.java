...
public class Segment_2D implements GeoShape {
	...
	/** -equals-
	 * Checks if the specified object is equal to this segment.
	 * Two segments are considered equal if they have the same two points.
	 * @param obj The object to compare with this segment.
	...
	public boolean equals(Object obj) {
		...
		Segment_2D otherSegment = (Segment_2D) obj;

		return (this.get_p1().equals(otherSegment.get_p1()) && this.get_p2().equals(otherSegment.get_p2())) ||
				(this.get_p1().equals(otherSegment.get_p2()) && this.get_p2().equals(otherSegment.get_p1()));
	}
}
