...
public class Triangle_2D implements GeoShape {
	...
	/**
	 * Determines whether the specified object is equal to this triangle.
	 * Two triangles are considered equal if they have the same three points.
	 * @param obj The object to compare with this triangle.
	...
	public boolean equals(Object obj) {
		...
		Triangle_2D otherTriangle = (Triangle_2D) obj;

		Point_2D[] thisPoints = this.getAllPoints();
		Point_2D[] otherPoints = otherTriangle.getAllPoints();

		int count = 0;
		for (Point_2D thisPoint : thisPoints) {
			for (Point_2D otherPoint : otherPoints) {
