...
public class Rect_2D implements GeoShape {
	...
	/** equals
	 * Checks if the specified object is equal to this rectangle.
	 * Two rectangles are considered equal if they have the same four points.
	 *
	 * @param obj The object to compare with this rectangle.
	 * @return True if the object is equal to this rectangle, false otherwise.
	 */
	@Override
	public boolean equals(Object obj) {
		...
		Rect_2D otherRectangle = (Rect_2D) obj;

		Point_2D[] thisPoints = new Point_2D[]{p1, p2, p3, p4};
		Point_2D[] otherPoints = new Point_2D[]{otherRectangle.getP1(), otherRectangle.getP2(), otherRectangle.getP3(), otherRectangle.getP4()};
