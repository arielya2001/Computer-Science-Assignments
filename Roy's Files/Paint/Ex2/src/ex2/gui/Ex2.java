 ...
 * README:
 * The Ex2, GUIShape and shapes classes are designed to create a drawing interface to draw graphical geometric shapes
 ...
 * The algorithm can handle mouse clicks and button presses to control the
 * collection of the geometric shapes, allowing operations such as
 * adding, removing, and modifying shapes in the 2D space. Modify a shape includes move, rotate, and scale.
 * Each shape is represented as a GUI_Shape object with properties like type, color, and its coordinates.
 * The algorithm also provides functionality to save and load the current
 * state of the shape collection to and from text files,
 ...
 * GeeksForGeeks:
 * <a href="https://www.geeksforgeeks.org/file-class-in-java/">...</a> - reading files and creating new ones
 * JUnit5
 * <a href="https://junit.org/junit5/docs/current/user-guide/">...</a> - @parametersTest and @methodSource for creating
 * more test cases with fewer lines of code
 *
