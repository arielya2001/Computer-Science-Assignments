...
class Circle_2DTest {
    ...
    static Stream<Arguments> circleArguments() {
        return Stream.of(
                Arguments.of(new Circle_2D(new Point_2D(0, 0), 1), new Circle_2D(new Point_2D(0, 0), 1), true),
                Arguments.of(new Circle_2D(new Point_2D(0, 0), 1), new Circle_2D(new Point_2D(1, 1), 1), false),
                Arguments.of(new Circle_2D(new Point_2D(0, 0), 2), new Circle_2D(new Point_2D(0, 0), 3), false),
                Arguments.of(new Circle_2D(new Point_2D(3, 4), 5), new Circle_2D(new Point_2D(3, 4), 5), true),
                Arguments.of(new Circle_2D(new Point_2D(-1, -1), 1), new Circle_2D(new Point_2D(-1, -1), 2), false)
        );
    }
    /////////////////////////////////////////////////////////
    ...
    public void Equals(Circle_2D circle1, Circle_2D circle2, boolean expected) {
        assertEquals(expected, circle1.equals(circle2));
    }
