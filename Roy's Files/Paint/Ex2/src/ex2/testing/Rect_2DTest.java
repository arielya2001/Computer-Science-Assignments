...
class Rect_2DTest {
    ...
    static Stream<Arguments> rectArguments() {
        return Stream.of(
                Arguments.of(
                        new Rect_2D(new Point_2D(0, 0), new Point_2D(2, 2)),
                        new Rect_2D(new Point_2D(0, 0), new Point_2D(2, 2)),
                        true
                ),
                Arguments.of(
                        new Rect_2D(new Point_2D(0, 0), new Point_2D(3, 3)),
                        new Rect_2D(new Point_2D(1, 1), new Point_2D(4, 4)),
                        false
                ),
                Arguments.of(
                        new Rect_2D(new Point_2D(0, 0), new Point_2D(2, 2)),
                        new Rect_2D(new Point_2D(2, 2), new Point_2D(0, 0)), // Same rectangle, different starting points
                        true
                ),
                Arguments.of(
                        new Rect_2D(new Point_2D(1, 1), new Point_2D(3, 3)),
                        new Rect_2D(new Point_2D(1, 1), new Point_2D(3, 3)),
                        true
                ));
    }
    ...
    @ParameterizedTest
    @MethodSource("rectArguments")
    public void Equals(Rect_2D rect1, Rect_2D rect2, boolean expected) {
