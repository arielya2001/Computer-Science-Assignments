...
class Polygon_2DTest {
    ...
    static Stream<Arguments> polygonProvider() {
        return Stream.of(
                Arguments.of(createPolygon(new Point_2D(0, 0), new Point_2D(1, 0), new Point_2D(1, 1), new Point_2D(0, 1)),
                        createPolygon(new Point_2D(0, 0), new Point_2D(1, 0), new Point_2D(1, 1), new Point_2D(0, 1)),
                        true),
                Arguments.of(createPolygon(new Point_2D(0, 0), new Point_2D(1, 0), new Point_2D(1, 1)),
                        createPolygon(new Point_2D(0, 0), new Point_2D(2, 0), new Point_2D(1, 1)),
                        false),
                Arguments.of(createPolygon(new Point_2D(0, 0), new Point_2D(1, 0), new Point_2D(0, 1)),
                        createPolygon(new Point_2D(0, 0), new Point_2D(1, 1), new Point_2D(0, 1)),
                        false),
                Arguments.of(createPolygon(new Point_2D(0, 0), new Point_2D(1, 1), new Point_2D(1, 2), new Point_2D(0, 3)),
                        createPolygon(new Point_2D(0, 0), new Point_2D(1, 1), new Point_2D(1, 2), new Point_2D(0, 3)),
                        true),
                Arguments.of(createPolygon(new Point_2D(3, 4), new Point_2D(5, 11), new Point_2D(12, 8), new Point_2D(9, 5), new Point_2D(5, 6)),
                        createPolygon(new Point_2D(3, 4), new Point_2D(5, 11), new Point_2D(12, 8), new Point_2D(9, 5), new Point_2D(5, 7)),
                        false)
        );
    }

    private static Polygon_2D createPolygon(Point_2D... points) {
    ...
    public void Equals(Polygon_2D polygon1, Polygon_2D polygon2, boolean expected) {
        assertEquals(expected, polygon1.equals(polygon2));
    }
